...
function elapsedTimeToString(elapsed_ms) {
    function getTimeString(elapsed_ms) {
        function zeroPad(milliseconds) {
            var prefix = '';
            if (milliseconds <= 9) {
                prefix = '00';
            }
...
function udpateServerStatus(status) {
...
exports.udpateServerStatus = udpateServerStatus;
